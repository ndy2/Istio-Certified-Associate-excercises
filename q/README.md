...
1. istiod 의 구성요소 설명
2. 특정 ns 에서 injection 활성화 하는 label
3. 특정 pod 에서 sidecar injection 을 수행하는 label
4. 이미 떠 있는 pod 에 injection 하는 방법
...
Q: How to upgrade istio?

---

Q: How to configure retry for a workload with label `app=bookinfo`

Q: How to make http request to `app=bookinfo` always abort with 503

Q: How to configure outlierDetection in DestinationRule

---

1. PeerAuthentication 과 Gateway 와 VirtualService 의 `tls` spec 각각 구분해서 이해
2. Istio 의 resilience 기능 이해 
